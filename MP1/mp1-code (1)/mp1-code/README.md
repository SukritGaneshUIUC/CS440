...
```
python mp1.py map/single/bigMaze.txt --method bfs
```
```
python mp1.py map/single/bigMaze.txt --method astar
```
```
python mp1.py map/corner/bigCorners.txt --method astar_corner
```
```
python mp1.py map/multi/bigSearch.txt --method astar_multi
```
```
python mp1.py map/multi/bigSearch.txt --scale 30 --fps 10 --human
```
